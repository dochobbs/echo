...
import { HomeIcon, HistoryIcon, UserIcon, StethoscopeIcon, LoginIcon, FolderIcon, SettingsIcon } from './icons';
...
export function MobileNav() {
  ...
  const navItems = [
    ...
    ...(user ? [
      ...
      ...(user.role === 'admin' ? [{ path: '/admin', label: 'Admin', Icon: SettingsIcon }] : []),
    ] : [
