...
export function UploadIcon({ className = '', size = 24 }: IconProps) {
  return (
    ...
    >
      ...
      <motion.polyline points="17 8 12 3 7 8" />
      <motion.line x1="12" y1="3" x2="12" y2="15" />
    </motion.svg>
  );
}
...
export function TrashIcon({ className = '', size = 24 }: IconProps) {
  return (
    <motion.svg
      ...
      whileTap={{ scale: 0.9 }}
    >
      <motion.polyline points="3 6 5 6 21 6" />
...
export function FolderIcon({ className = '', size = 24 }: IconProps) {
  return (
    ...
    >
      <motion.path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z" />
    </motion.svg>
  );
}
...
export function ChevronLeftIcon({ className = '', size = 24 }: IconProps) {
  return (
    <motion.svg
      ...
      whileHover={{ x: -2 }}
    >
      <motion.polyline points="15 18 9 12 15 6" />
    </motion.svg>
  );
}
